...
@section('content')
    <div class="max-w-7xl mx-auto px-4 py-10">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <form method="GET" action="{{ route('publico.modulos.index') }}" class="flex items-center gap-2">
        ...
        <div class="space-y-4">
            @forelse($modulos as $modulo)
                <div class="card flex items-center justify-between">
                    ...
                    <a href="{{ route('publico.modulos.show', $modulo) }}" class="btn-secondary ml-4 shrink-0">
                        Ver ficha
                    </a>
                </div>
            @empty

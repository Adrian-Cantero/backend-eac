    ...
    <div class="max-w-7xl mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach ($modulos as $modulo)
                <a href="{{ route('publico.modulos.show', $modulo) }}" class="card hover:shadow-md transition-shadow group">
                    ...
                    <h3
                        class="text-base font-semibold text-gray-800 group-hover:text-vfds-primary

...
@section('panel')
    <div class="space-y-6">
        ...
        <div>
            <a href="{{ route('estudiante.dashboard') }}" class="text-sm text-gray-400 hover:text-vfds-primary">← Panel</a>
                ...
                @foreach ($perfil->ecosistemaLaboral->situacionesCompetencia->sortBy('codigo') as $sc)
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            @if ($estaConquistada)
                                @php
                                    $pivot = $perfil->situacionesConquistadas->firstWhere('id', $sc->id)->pivot;
                                @endphp

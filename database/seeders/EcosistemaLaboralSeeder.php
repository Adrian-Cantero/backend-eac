...
class EcosistemaLaboralSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('huellas_talento')->truncate();
        EcosistemaLaboral::truncate();
        ...
        DB::table('sc_criterios_evaluacion')->truncate();
        ...
        DB::table('sc_precedencia')->truncate();
